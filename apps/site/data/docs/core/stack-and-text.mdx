...
When set a `defaultFont` is defined in your `tamagui.config.ts` and it's set to be one of key values found in the correct part of the design system, you basically d (missing ending)
